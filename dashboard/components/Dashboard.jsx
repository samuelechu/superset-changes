...
class Dashboard extends React.PureComponent {
  constructor(props) {
    ...
    this.props.actions.saveSliceWithURL = this.props.actions.saveSliceWithURL.bind(this);
    this.props.actions.setControlValue = this.props.actions.setControlValue.bind(this);
  }
      ...
      <div id="dashboard-container">
        ...
        <div id="dashboard-header">
          ...
          <Header
            ...
            saveSlice={this.props.actions.saveSliceWithURL}
